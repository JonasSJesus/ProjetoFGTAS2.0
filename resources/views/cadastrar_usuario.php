    ...
    <form method="post" class="formulario mt12-5 centralizado">
        <fieldset class="formulario__campo w80">
            ...
            <section class="centralizado">
                ...
                <div>
                    <input type="text" class="formulario__entrada w90" value='' name="nomeUsuario"  id="nomeUsuario" placeholder="João da Silva"  >
                </div>
            </section>
            ...
            <section>
                ...
                <div class="mv0-5">
                    <input value="" type="password" id="senhaUsuario" name="senhaUsuario" class="formulario__entrada w80"  maxlength="20">
            ...
            <fieldset class="sem_borda mh2 mv1 centralizado">
                <legend class="formulario__legenda">Cargo</legend>
                    <select name="cargo" required class="formulario__selecao w90">
        ...
        <div class="w80 centralizado mv0-5">
            <a href="/admin" class="formulario__botao__secundario formulario__botao__padrao">Voltar</a>
